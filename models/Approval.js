...
const approvalSchema = new mongoose.Schema({
  ...
  email: { type: String, required: false, lowercase: true }, // Not unique as per your register.js
  ...
  salt: { type: String, required: true }, // New salt field
  plain_password_temp: { type: String, required: false },
